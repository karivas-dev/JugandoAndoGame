...
"La propiedad intelectual es tener derechos sobre nuestras creaciones. Protege lo que creamos y nos asegura que nadie pueda copiar o usarlas sin permiso.",
		...
		"En El Salvador, el Centro Nacional de Registros (CNR) es la institución encargada de los registros de creaciones y obras en el país.",
		...
		"Una vez protegidas, podemos comercializar nuestras invenciones y obras. Esto implica venderlas a interesados o licenciar nuestros derechos de autor para que otros puedan usar nuestras creaciones a cambio de un pago.",
		...
		"La propiedad intelectual no protege las ideas, esta protege las creaciones u obras realizadas, como pinturas, libros, historias, marcas, logotipos, ilustraciones, entre otros."   
	};
